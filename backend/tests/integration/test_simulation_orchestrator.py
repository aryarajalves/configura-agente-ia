...
async def test_simulation_orchestrator_flow(db_session):
    ...
    # OrchestratorService.route_decision uses 'from backend.src.database import AsyncSessionLocal'
    ...
    with patch("backend.src.database.AsyncSessionLocal", mock_session_factory):
